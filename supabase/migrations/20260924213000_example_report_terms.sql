-- Accept the new version without rewriting existing agreements.
-- Keep the previous version available for already open booking forms.
...
begin
  if p_terms_version is null or p_terms_version not in ('2026-09-21', '2026-09-24') then
