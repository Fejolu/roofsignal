...
drop policy if exists "hr records owner managed" on public.employee_records;
drop policy if exists "hr leave owner managed" on public.employee_leave;
drop policy if exists "hr absence owner managed" on public.employee_absence;
drop policy if exists "hr documents owner managed" on public.employee_documents;
...
drop policy if exists "hr document objects owner read" on storage.objects;
drop policy if exists "hr document objects owner insert" on storage.objects;
drop policy if exists "hr document objects owner update" on storage.objects;
drop policy if exists "hr document objects owner delete" on storage.objects;
