...
Administrator and Finance roles need a complete financial cockpit.

Goal:

- All financial information should be centrally available.
- Finance users should be able to export accountant-ready data with one action.
- Exports should support VAT filings, annual accounts, income tax, and corporate tax preparation.
- The finance model must stay open for later bookkeeping integrations.
...
- Orders still to invoice.

Financial administration must support:
...
- Payment reminders.
- VAT administration.
- General ledger categories for future bookkeeping connections.

Automatic payment reminders:

- First reminder: automatic.
- Second reminder: automatic.
- Third reminder: automatic.
- After the second reminder, automatically create a Backoffice or Finance task: "Call this customer about the outstanding invoice."
- Every week, generate an action list of all customers that need personal follow-up.

The Finance Hub should be treated as an internal operating module, not as a customer portal screen.

## Accountant Export

The platform must be able to export financial data in accountant-ready formats.
...
The export should be structured so an accountant can use it nearly one-to-one for:
...
The architecture should remain open for future integrations with:
...
This requires clean separation between commercial documents, accounting categories, VAT treatment, payment events, subscriptions, and export jobs.

## Management Dashboard

Administrators need a daily management cockpit.

Goal:

- The RoofSignal owner should be able to open one dashboard every morning and immediately understand company performance.
- The dashboard should combine operational, commercial, Property Intelligence, financial, and staff signals.
- This dashboard should become the daily command center for running RoofSignal.
...
The Management Dashboard should reuse the same object, CRM, ERP, planning, finance, and staff data model instead of becoming a separate reporting silo.
